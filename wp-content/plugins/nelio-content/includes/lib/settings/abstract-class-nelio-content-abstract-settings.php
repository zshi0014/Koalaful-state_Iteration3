...
abstract class Nelio_Content_Abstract_Settings {
	...
	public function init() {
		...
		add_action( 'plugins_loaded', [ $this, 'set_tabs' ], 1 );
		add_action( 'plugins_loaded', [ $this, 'mark_as_ready' ], 1 );
	...
	public function get( $name, $value = false ) {
		...
		$settings = get_option( $this->get_name(), [] );
	...
	public function open_tab_content( $tab ) {
		...
		echo '<div id="' . esc_attr( $tab['name'] ) . '-tab-content" class="tab-content" style="display:none;">';
