...
class Nelio_Content_Post_Saving {
	...
	public function init() {
		add_action( 'plugins_loaded', [ $this, 'add_hooks_to_trigger_custom_save_post_action' ] );
		add_action( 'plugins_loaded', [ $this, 'maybe_add_hooks_to_notify_post_followers' ] );
		add_action( 'nelio_content_save_post', [ $this, 'add_default_post_followers' ], 1, 2 );
	}//end init()
	...
	public function add_hooks_to_trigger_custom_save_post_action() {
		...
		foreach ( $settings->get( 'calendar_post_types' ) as $post_type ) {
