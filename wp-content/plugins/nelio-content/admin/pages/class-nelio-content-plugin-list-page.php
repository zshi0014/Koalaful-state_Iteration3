...
class Nelio_Content_Plugin_List_Page {
	...
	public function init() {
		...
		add_action( 'plugin_action_links_' . nelio_content()->plugin_file, [ $this, 'customize_plugin_actions' ] );
	...
	public function customize_plugin_actions( $actions ) {
		...
		if ( current_user_can( 'deactivate_plugin', nelio_content()->plugin_file ) ) {
